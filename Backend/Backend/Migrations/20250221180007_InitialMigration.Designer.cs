...
namespace Backend.Migrations
{
    ...
    [Migration("20250221180007_InitialMigration")]
            ...
            modelBuilder.Entity("Backend.Entities.Membership", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            MembershipID = new Guid("48923344-0974-45f1-8d72-25030d19437e"),
                            MembershipFrom = new DateTime(2025, 2, 21, 19, 0, 7, 79, DateTimeKind.Local).AddTicks(5208),
                            MembershipPlanID = new Guid("b1780029-6d8d-45cc-ab53-e3d20433007b"),
                            MembershipStatus = "Ongoing",
                            MembershipTo = new DateTime(2025, 2, 21, 19, 0, 7, 81, DateTimeKind.Local).AddTicks(9211)
                        },
                        new
                        {
                            MembershipID = new Guid("ac6e2085-57ec-4c1e-a34c-42408b9daebe"),
                            MembershipFrom = new DateTime(2025, 2, 21, 19, 0, 7, 82, DateTimeKind.Local).AddTicks(1305),
                            MembershipPlanID = new Guid("b1780029-6d8d-45cc-ab53-e3d20433007b"),
                            MembershipStatus = "Ongoing",
                            MembershipTo = new DateTime(2025, 2, 21, 19, 0, 7, 82, DateTimeKind.Local).AddTicks(1321)
                        });
                });
